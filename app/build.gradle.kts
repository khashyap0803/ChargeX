...
aboutLibraries {
    license {
        allowedLicenses = setOf(
            ...
            // exact display names from AboutLibraries plugin detection
            "Eclipse Distribution License - v 1.0",  // jts-core
            "Eclipse Public License, Version 2.0",    // jts-core
            "BSD 3-Clause License",                   // osm-legal-default-speeds-jvm
            "LGPL 3",                                 // osmosis-osm-binary
            "The BSD License",                        // stax2-api
            // SPDX alternates
            "EPL-2.0", "EDL-1.0", "LGPL-3.0-only", "LGPL-3.0",
            "asdkl",  // Android SDK
