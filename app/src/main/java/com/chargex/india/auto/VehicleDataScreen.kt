...
import com.chargex.india.ui.CompassNeedle
import com.chargex.india.ui.Gauge
...
class VehicleDataScreen(ctx: CarContext, val session: ChargeXSession) : Screen(ctx),
