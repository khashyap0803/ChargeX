...
import com.chargex.india.model.StationOccupancy
import com.chargex.india.api.goingelectric.GEChargepoint
import com.chargex.india.api.goingelectric.GENetwork
import com.chargex.india.api.goingelectric.GEPlug
import com.chargex.india.api.openchargemap.OCMConnectionType
import com.chargex.india.api.openchargemap.OCMCountry
import com.chargex.india.api.openchargemap.OCMOperator
import com.chargex.india.model.BooleanFilterValue
...
import com.chargex.india.model.MultipleChoiceFilterValue
import com.chargex.india.model.SliderFilterValue
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        fun getInstance(context: Context): AppDatabase {
            return INSTANCE ?: synchronized(this) {
                INSTANCE ?: initDb(SpatiaRoom.databaseBuilder(context.applicationContext, AppDatabase::class.java, "chargex.db")).also { INSTANCE = it }
            }
        }
        ...
        private val MIGRATION_2 = object : Migration(1, 2) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // SQL for creating tables copied from build/generated/source/kapt/debug/com/chargex/india/storage/AppDatbase_Impl
        ...
        private val MIGRATION_13 = object : Migration(12, 13) {
            ...
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                try {
                    ...
                    // Update GoingElectric format of plug types for favorites to generic ChargeX format
    ...
    /**
     * Creates a backup of the database to chargex-backup.db.
    ...
    suspend fun createBackup(context: Context, fileName: String) {
        val dbFile = context.applicationContext.getDatabasePath("chargex.db")
